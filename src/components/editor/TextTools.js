...
const buttonStyle = css(
  s.relative,
  s.zIndex1,
  { width: 30, height: 30, lineHeight: '30px', marginLeft: 1, borderRadius: '50%' },
  s.fontSize14,
  s.colorA,
  s.center,
  s.alignMiddle,
  ...
  select('&.forItalic > em', s.monoRegular, s.italic, { marginLeft: -2 }),
...
const inputStyle = css(
  s.inlineBlock,
  { width: 210, height: 30, padding: '0 10px 0 35px', borderRadius: 15 },
  s.fontSize14,
  s.colorBlack,
  s.alignBaseline,
  s.bgcWhite,
