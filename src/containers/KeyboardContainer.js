...
import { SET_LAYOUT_MODE } from 'ello-brains/dist/constants/action_types'
import { selectIsLoggedIn } from 'ello-brains/dist/selectors/authentication'
import { SHORTCUT_KEYS } from 'ello-brains/dist/constants/application_types'
import { selectDiscoverKeyType, selectIsGridMode } from 'ello-brains/dist/selectors/gui'
